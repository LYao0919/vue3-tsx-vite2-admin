 ...
 * @LastEditTime: 2022-06-23 13:25:55
 * @Description: 
 * @LastEditors: luyao
 * @FilePath: /dmd-pc/src/components/dbsTable/columnRender.tsx
 */
        ...
        const allSlots = (item: any) => {
            return {
                default: ({ row, $index }: any) => {
                    ...
                    return item.slot && props.parentSlots[item.slot] ? props.parentSlots[item.slot]({ scope: { row, $index } }) : null
                },
            }
        }
